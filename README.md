...
- **Log a note** after any interaction that isn't captured automatically: a phone call, a text, a coffee, a LinkedIn DM thread. Describe what happened and the system extracts any commitments and updates the record
...
Second, if you have a meaningful exchange on LinkedIn, a DM thread that goes somewhere or a connection who responds to an outreach, log it the same way you'd log a phone call. Tell Claude what happened and it updates the interaction history and extracts any commitments.
...
Each brief draws from your CRM history, your meeting notes tool (if connected), LinkedIn, and optionally the web. You choose the depth: quick, standard, or deep research. Files are named `YYYY-MM-DD - Name - Company` and saved in your preferred format (.md, .docx, or .txt).
...
*Built on Claude Desktop. Your data stays on your machine. Requires a Claude Pro subscription.*
